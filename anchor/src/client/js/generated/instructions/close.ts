...
export type CloseInput<
  ...
  TAccountFirstproject extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountFirstproject>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountFirstproject> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.firstproject),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountFirstproject>;
